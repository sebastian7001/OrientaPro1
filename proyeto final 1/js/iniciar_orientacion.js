...
function verificarAcceso() {
  ...
  const usuarios = [
    { correo: "23.gomez.aguilar.sebastian@cetis120.edu.mx", clave: "12345", redireccion: "reportes.html" },
    { correo: "admin@cetis120.com", clave: "admin123", redireccion: "reportes.html" },
    { correo: "alumno@cetis120.com", clave: "alumno123", redireccion: "reportes.html" },
    { correo: "orientador@cetis120.com", clave: "orientador123", redireccion: "reportes.html" },
    { correo: "mateo@cetis120.com", clave: "mateo123", redireccion: "reportes.html" }
  ];

  const usuariosLocales = JSON.parse(localStorage.getItem('usuarios') || '[]');
  const todosUsuarios = [...usuarios, ...usuariosLocales.map(u => ({ ...u, redireccion: 'reportes.html' }))];
